...
@NamedNativeQueries({
	@NamedNativeQuery(
			name="searchLeave",
					query="select l.id,l.aim,l.start_time,l.end_time,l.reason, m.name, l.employee_id, emp.employee_code, m.id,aim.NAME_ENG as NAME_ENG,l.STARTTIMESTRING,l.ENDTIMESTRING "
