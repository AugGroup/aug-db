...
import org.hibernate.annotations.NamedNativeQuery;
 ...
 @NamedNativeQueries({
   ...
   @NamedNativeQuery(name = "SEARCH_LANGUAGE_UNIQUE", query = "SELECT LANGUAGE.ID,LANGUAGE.APPLICANT_ID, LANGUAGE.NAMELANGUAGE, LANGUAGE.SPEAKING, LANGUAGE.READING, LANGUAGE.UNDERSTANDING, LANGUAGE.WRITING "
                            + " FROM LANGUAGE LEFT JOIN APPLICANT on LANGUAGE.APPLICANT_ID = APPLICANT.ID WHERE LANGUAGE.APPLICANT_ID = :ID and LANGUAGE.NAMELANGUAGE like :LANGUAGENAME", resultClass = LanguageDto.class),
    })
