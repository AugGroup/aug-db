...
@NamedNativeQueries({
	...
	@NamedNativeQuery(name = "SEARCH_BY_ID_APPLICATION", query = "SELECT null as MAS_JOB_LEVEL_NAME, null as MAS_TECHNOLOGY_NAME, a.ID, a.APPLICANT_CODE, a.FIRSTNAME_TH, a.FIRSTNAME_EN, a.LASTNAME_TH, a.LASTNAME_EN, a.NICKNAME_TH, a.NICKNAME_EN,"
		...
		+ "a.EMPLOYED_RELATION, a.BRANCH_SERVICE, a.PREVIOUS_EMPLOYERS, a.PREVIOUS_EMPLOYERS_REASON, a.DATE_TO_BE_DRAFTED, a.MARRIAGE_ADDRESS, a.EMERGENCY_NAME,a.EMERGENCY_TEL,a.EMERGENCY_ADDRESS,a.RESUME,a.TRANSCRIPT,a.IMAGE,a.SEX, a.CREATEDTIMESTAMP, a.CREATEDBY,a.MASJOBLEVEL_ID,a.MASTECHNOLOGY_ID,job.ID,tech.ID, job.NAME,tech.NAME, job.TAG  "
	...
	@NamedNativeQuery(name = "SEARCH_APPLICANT", query = " SELECT null as FIRSTNAME_TH, null as LASTNAME_TH, null as NICKNAME_TH, null as NICKNAME_EN, "
			+ "job.NAME as JOB_LEVEL_NAME,tech.NAME as TECHNOLOGY_NAME,null as BIRTHDATE, null as AGE, null as HEIGHT, null as WEIGHT, null as SEX, null as RELIGION, null as NATIONALITY, null as APPLICANT_STATUS, null as EMERGENCY_NAME, null as EMERGENCY_TEL,"
			...
			+ "a.ID, a.APPLICANT_CODE, a.FIRSTNAME_EN, a.LASTNAME_EN, a.TEL, a.EMAIL, a.APPLY_DATE, a.MASJOBLEVEL_ID, a.TRACKING_STATUS, a.CREATEDTIMESTAMP, a.CREATEDBY, job.NAME, job.ID, tech.NAME, tech.ID ,a.LOCATION, job.TAG  "
			+ "FROM APPLICANT a LEFT JOIN MAS_JOBLEVEL job ON a.MASJOBLEVEL_ID = job.ID "
	...
	@NamedNativeQuery(name = "SEARCH_ALL", query = "SELECT null as FIRSTNAME_TH, null as LASTNAME_TH, null as NICKNAME_TH, null as NICKNAME_EN, "
			...
			+ " a.ID, a.APPLICANT_CODE, a.FIRSTNAME_EN, a.LASTNAME_EN, a.TEL, a.EMAIL, a.APPLY_DATE, a.MASJOBLEVEL_ID, a.TRACKING_STATUS, job.NAME, job.ID, tech.NAME, tech.ID ,a.LOCATION, job.TAG  "
			+ " FROM APPLICANT a LEFT JOIN MAS_JOBLEVEL job ON a.MASJOBLEVEL_ID = job.ID "
			+ " LEFT JOIN MAS_TECHNOLOGY tech ON a.MASTECHNOLOGY_ID = tech.ID "
	...
	@NamedNativeQuery(name = "SEARCH_BY_ID", query = "SELECT a.FIRSTNAME_TH, a.LASTNAME_TH, a.NICKNAME_TH, a.NICKNAME_EN, "
					+ "job.NAME as JOB_LEVEL_NAME,tech.NAME as TECHNOLOGY_NAME,null as MAS_JOB_LEVEL_NAME,null as MAS_TECHNOLOGY_NAME, a.BIRTHDATE, a.AGE, a.HEIGHT, a.WEIGHT, a.SEX, a.RELIGION, a.NATIONALITY, a.APPLICANT_STATUS, a.EMERGENCY_NAME, a.EMERGENCY_TEL,"
					...
					+ " a.ID, a.APPLICANT_CODE, a.FIRSTNAME_EN, a.LASTNAME_EN, a.TEL, a.EMAIL, a.APPLY_DATE, a.MASJOBLEVEL_ID, a.TRACKING_STATUS, a.CREATEDTIMESTAMP, a.CREATEDBY, job.NAME, job.ID, tech.NAME, tech.ID, job.TAG  "
					+ "FROM APPLICANT a LEFT JOIN MAS_JOBLEVEL job ON a.MASJOBLEVEL_ID = job.ID "
					+ "LEFT JOIN MAS_TECHNOLOGY tech ON a.MASTECHNOLOGY_ID = tech.ID "
	...
	@NamedNativeQuery(name = "SEARCH_BY_TRACKINGSTATUS", query = "SELECT null as FIRSTNAME_TH, null as LASTNAME_TH, null as NICKNAME_TH, null as NICKNAME_EN, "
			...
			+ " a.ID, null as APPLICANT_CODE,null as CREATEDTIMESTAMP, a.FIRSTNAME_EN, a.LASTNAME_EN, null as TEL, null as EMAIL, null as APPLY_DATE, a.MASJOBLEVEL_ID, a.MASTECHNOLOGY_ID, a.TRACKING_STATUS, job.NAME, job.ID, tech.NAME, tech.ID,a.LOCATION, job.TAG "
			+ "FROM APPLICANT a LEFT JOIN MAS_JOBLEVEL job ON a.MASJOBLEVEL_ID = job.ID "
			+ "LEFT JOIN MAS_TECHNOLOGY tech ON a.MASTECHNOLOGY_ID = tech.ID "
