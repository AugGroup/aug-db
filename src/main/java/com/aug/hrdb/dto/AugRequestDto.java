...
@Entity
@NamedNativeQueries({
		@NamedNativeQuery(name = "SEARCH_ALL_REQUEST", query = "SELECT a.ID, a.REQUEST_DATE, a.REQUESTER_NAME, a.STATUS, a.APPROVAL_NAME,a.APPROVE_DATE, a.NUMBER_APPLICANT, a.SPECIFIC_SKILL,"
				+ " a.YEAR_EXPERIENCE,null as MAS_JOB_LEVEL_NAME,null as MAS_TECHNOLOGY_NAME,a.MASJOBLEVEL_ID,a.MASTECHNOLOGY_ID, j.ID, t.ID "
				+ "FROM AUG_REQUEST a LEFT JOIN MAS_JOBLEVEL j ON a.MASJOBLEVEL_ID = j.ID LEFT JOIN MAS_TECHNOLOGY t ON a.MASTECHNOLOGY_ID = t.ID ORDER BY REQUEST_DATE DESC", resultClass = AugRequestDto.class), //REQUEST_ID ASC LIMIT 0,50
		
		@NamedNativeQuery(name = "SEARCH_REQUEST_BY_ID", query = "SELECT a.ID, a.REQUEST_DATE, a.REQUESTER_NAME, a.STATUS, a.APPROVAL_NAME,a.APPROVE_DATE, a.NUMBER_APPLICANT, a.SPECIFIC_SKILL,"
				+ " a.YEAR_EXPERIENCE,null as MAS_JOB_LEVEL_NAME,null as MAS_TECHNOLOGY_NAME,a.MASJOBLEVEL_ID,a.MASTECHNOLOGY_ID, j.ID, t.ID"
				+ " FROM AUG_REQUEST a LEFT JOIN MAS_JOBLEVEL j ON a.MASJOBLEVEL_ID = j.ID LEFT JOIN MAS_TECHNOLOGY t ON a.MASTECHNOLOGY_ID = t.ID WHERE REQUEST_ID = :ID", resultClass = AugRequestDto.class),
		//TEST SQLGrammaException		
		
		@NamedNativeQuery(name = "SEARCH_REQUEST_BY_ID_TEST", query = "SELECT a.ID, a.REQUEST_DATE, a.REQUESTER_NAME, a.STATUS, a.APPROVAL_NAME,a.APPROVE_DATE, a.NUMBER_APPLICANT, a.SPECIFIC_SKILL,"
						+ " a.YEAR_EXPERIENCE,null as MAS_JOB_LEVEL_NAME,null as MAS_TECHNOLOGY_NAME,a.MASJOBLEVEL_ID,a.MASTECHNOLOGY_ID, j.ID, t.ID"
						+ " FROM AUG_REQUEST a LEFT JOIN MAS_JOBLEVEL j ON a.MASJOBLEVEL_ID = j.ID LEFT JOIN MAS_TECHNOLOGY t ON a.MASTECHNOLOGY_ID = t.ID WHERE REQUEST_ID = :ID", resultClass = AugRequestDto.class)})
