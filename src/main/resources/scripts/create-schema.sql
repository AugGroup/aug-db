    ...
    alter table ALLOWANCES 
        drop 
        foreign key FKCD0A575B218FFC07;

    alter table APPLICANT 
        drop 
        foreign key FK29852EE2EC8A3989;

    alter table APPLICANT 
        drop 
        foreign key FK29852EE28CF9B92B;

    alter table APPLICANT 
        drop 
        foreign key FK29852EE2B0E87A49;
    ...
    alter table APPLICANT 
        drop 
        foreign key FK29852EE22A3A7CC9;
    ...
    alter table AUG_REQUEST 
        drop 
        foreign key FK218E0C38CF9B92B;

    alter table AUG_REQUEST 
        drop 
        foreign key FK218E0C3D4BCA2EB;

    alter table AUG_REQUEST 
        drop 
        foreign key FK218E0C397C3EA6A;

    alter table AUG_REQUEST 
        drop 
        foreign key FK218E0C367139BE8;

    alter table CARD 
        drop 
        foreign key FK1F73109B593F69;

    alter table CAREER_CASE 
        drop 
        foreign key FK4F72AF51DED17B4A;

    alter table CAREER_CASE 
        drop 
        foreign key FK4F72AF5146537B0A;

    alter table CAREER_CASE 
        drop 
        foreign key FK4F72AF51B8618A;

    alter table CAREER_CASE 
        drop 
        foreign key FK4F72AF5146EF9E09;

    alter table CAREER_CASE 
        drop 
        foreign key FK4F72AF51D0FFBF6A;

    alter table CAREER_CASE 
        drop 
        foreign key FK4F72AF5164560D0A;

    alter table CAREER_CASE_SPECIALTY 
        drop 
        foreign key FK83D58D704FFE234A;

    alter table CAREER_CASE_SPECIALTY 
        drop 
        foreign key FK83D58D70BF55546;
    ...
    alter table LOGINROLE 
        drop 
        foreign key FK3FABA33F1BEB470B;

    alter table LOGINROLE 
        drop 
        foreign key FK3FABA33F81728B6B;
    ...
    alter table RESERVATION 
        drop 
        foreign key FK2328D7AC3EC103C9;

    alter table RESERVATION 
        drop 
        foreign key FK2328D7AC9B593F69;

    alter table RESERVATION 
        drop 
        foreign key FK2328D7ACF9C1D24A;

    alter table RESERVATION 
        drop 
        foreign key FK2328D7AC9BF67E43;
    ...
    drop table if exists CAREER_CASE;

    drop table if exists CAREER_CASE_SPECIALTY;
    ...
    drop table if exists MAS_RESERVATION_TYPE;
    ...
    create table APPLICANT (
        ...
        WEIGHT integer,
        AUGREQUEST_ID integer,
        MASCORESKILL_ID integer not null,
    ...
    create table AUG_REQUEST (
        ...
        JOBCASE_CODE varchar(255),
        JOBCASE_STATUS varchar(255),
    ...
    create table CAREER_CASE (
        ...
        START_DATE date,
        CLIENT_ID integer,
        MAS_CAREER_CASE_STATUS_ID integer,
        MAS_CORESKILL_ID integer,
        MAS_DIVISION_ID integer,
        MAS_JOBLEVEL_ID integer,
        MAS_TECHNOLOGY_ID integer,
        primary key (ID)
    );

    create table CAREER_CASE_SPECIALTY (
        CAREER_CASE_ID integer not null,
        SPECIALTY_ID integer not null
    );
    ...
    create table MAS_CAREER_CASE_STATUS (
        ID integer not null auto_increment,
        AUDITFLAG varchar(1) not null,
        CREATEDBY integer not null,
        CREATEDTIMESTAMP datetime not null,
    ...
    create table MAS_RESERVATION_TYPE (
        ID integer not null auto_increment,
        AUDITFLAG varchar(1) not null,
        CREATEDBY integer not null,
        CREATEDTIMESTAMP datetime not null,
    ...
    alter table APPLICANT 
        ...
        add constraint FK29852EE2EC8A3989 
        foreign key (MASCORESKILL_ID) 
        references MAS_CORESKILL (ID);

    alter table APPLICANT 
        add index FK29852EE28CF9B92B (MASJOBLEVEL_ID), 
        add constraint FK29852EE28CF9B92B 
        foreign key (MASJOBLEVEL_ID) 
        references MAS_JOBLEVEL (ID);

    alter table APPLICANT 
        add index FK29852EE2B0E87A49 (OFFICIAL_ID), 
        add constraint FK29852EE2B0E87A49 
    ...
    alter table APPLICANT 
        add index FK29852EE22A3A7CC9 (AUGREQUEST_ID), 
        add constraint FK29852EE22A3A7CC9 
        foreign key (AUGREQUEST_ID) 
        references AUG_REQUEST (ID);
    ...
    alter table AUG_REQUEST 
        add index FK218E0C38CF9B92B (MASJOBLEVEL_ID), 
        add constraint FK218E0C38CF9B92B 
        foreign key (MASJOBLEVEL_ID) 
        references MAS_JOBLEVEL (ID);

    alter table AUG_REQUEST 
        add index FK218E0C3D4BCA2EB (MASTECHNOLOGY_ID), 
        add constraint FK218E0C3D4BCA2EB 
        foreign key (MASTECHNOLOGY_ID) 
        references MAS_TECHNOLOGY (ID);

    alter table AUG_REQUEST 
        add index FK218E0C397C3EA6A (APPROVE_ID), 
        add constraint FK218E0C397C3EA6A 
        foreign key (APPROVE_ID) 
        references EMPLOYEE (ID);

    alter table AUG_REQUEST 
        add index FK218E0C367139BE8 (REQUEST_ID), 
        add constraint FK218E0C367139BE8 
    ...
    alter table CAREER_CASE 
        add index FK4F72AF51DED17B4A (MAS_CAREER_CASE_STATUS_ID), 
        add constraint FK4F72AF51DED17B4A 
        foreign key (MAS_CAREER_CASE_STATUS_ID) 
        references MAS_CAREER_CASE_STATUS (ID);

    alter table CAREER_CASE 
        add index FK4F72AF5146537B0A (MAS_TECHNOLOGY_ID), 
        add constraint FK4F72AF5146537B0A 
        foreign key (MAS_TECHNOLOGY_ID) 
        references MAS_TECHNOLOGY (ID);

    alter table CAREER_CASE 
        add index FK4F72AF51B8618A (MAS_CORESKILL_ID), 
        add constraint FK4F72AF51B8618A 
        foreign key (MAS_CORESKILL_ID) 
        references MAS_CORESKILL (ID);

    alter table CAREER_CASE 
        add index FK4F72AF5146EF9E09 (CLIENT_ID), 
        add constraint FK4F72AF5146EF9E09 
        foreign key (CLIENT_ID) 
        references CLIENT (ID);

    alter table CAREER_CASE 
        add index FK4F72AF51D0FFBF6A (MAS_DIVISION_ID), 
        add constraint FK4F72AF51D0FFBF6A 
        foreign key (MAS_DIVISION_ID) 
        references MAS_DIVISION (ID);

    alter table CAREER_CASE 
        add index FK4F72AF5164560D0A (MAS_JOBLEVEL_ID), 
        add constraint FK4F72AF5164560D0A 
        foreign key (MAS_JOBLEVEL_ID) 
        references MAS_JOBLEVEL (ID);

    alter table CAREER_CASE_SPECIALTY 
        add index FK83D58D704FFE234A (SPECIALTY_ID), 
        add constraint FK83D58D704FFE234A 
        foreign key (SPECIALTY_ID) 
        references MAS_SPECIALTY (ID);

    alter table CAREER_CASE_SPECIALTY 
        add index FK83D58D70BF55546 (CAREER_CASE_ID), 
        add constraint FK83D58D70BF55546 
        foreign key (CAREER_CASE_ID) 
        references CAREER_CASE (ID);
    ...
    alter table LOGINROLE 
        add index FK3FABA33F81728B6B (MASROLE_ID), 
    ...
    alter table RESERVATION 
        add index FK2328D7AC3EC103C9 (ROOM_ID), 
        add constraint FK2328D7AC3EC103C9 
        foreign key (ROOM_ID) 
        references ROOM (ID);

    alter table RESERVATION 
        add index FK2328D7AC9B593F69 (EMPLOYEE_ID), 
        add constraint FK2328D7AC9B593F69 
        foreign key (EMPLOYEE_ID) 
        references EMPLOYEE (ID);

    alter table RESERVATION 
        add index FK2328D7ACF9C1D24A (DIVISION_ID), 
        add constraint FK2328D7ACF9C1D24A 
        foreign key (DIVISION_ID) 
        references MAS_DIVISION (ID);

    alter table RESERVATION 
        add index FK2328D7AC9BF67E43 (RESERVATION_TYPE_ID), 
        add constraint FK2328D7AC9BF67E43 
        foreign key (RESERVATION_TYPE_ID) 
        references MAS_RESERVATION_TYPE (ID);
