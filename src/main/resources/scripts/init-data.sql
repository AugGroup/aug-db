--MAS_ADDRESSTYPE
INSERT INTO MAS_ADDRESSTYPE (ADDRESSTYPENAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY) VALUES
('Present address','P01',1,'C',NOW(),0),
...
--MAS_CAREER_CASE_STATUS
INSERT INTO MAS_CAREER_CASE_STATUS (NAME,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP) VALUES ("Sourcing",'C',0,NOW());
INSERT INTO MAS_CAREER_CASE_STATUS (NAME,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP) VALUES ("Interviewing",'C',0,NOW());
INSERT INTO MAS_CAREER_CASE_STATUS (NAME,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP) VALUES ("Offer",'C',0,NOW());
INSERT INTO MAS_CAREER_CASE_STATUS (NAME,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP) VALUES ("On Boarding",'C',0,NOW());
...
INSERT INTO MAS_DIVISION (NAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY,TAG) VALUES ('Integrate Technology Services','ITS',0,'C',NOW(),0,'B');
INSERT INTO MAS_DIVISION (NAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY,TAG) VALUES ('Marketing','MKT',0,'C',NOW(),0,'S');
INSERT INTO MAS_DIVISION (NAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY,TAG) VALUES ('Ministry of Happiness','MoH',0,'C',NOW(),0,'S');
INSERT INTO MAS_DIVISION (NAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY,TAG) VALUES ('Services','SAP',0,'C',NOW(),0,'S');
INSERT INTO MAS_DIVISION (NAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY,TAG) VALUES ('Transformation','TXM',0,'C',NOW(),0,'S');
...
--MAS_LOCATION
INSERT INTO MAS_LOCATION (NAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY) VALUES 
('Thailand','TH',1,'C',NOW(),0),
('Singapore','SG',1,'C',NOW(),0),
('Indonesia','ID',1,'C',NOW(),0),
('Australia','AU',1,'C',NOW(),0);

--MAS_PROVINCE
insert into MAS_PROVINCE (PROVINCENAME,CODE,ISACTIVE,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY) VALUES
('Bangkok','a',1,'C',NOW(),0),
...
--MAS_STAFFTYPE
INSERT INTO MAS_STAFFTYPE (AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP,CODE,ISACTIVE,STAFFTYPENAME) VALUES
...
--CLIENT
INSERT INTO CLIENT (NAME,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY) VALUES ('Progress Software','C',NOW(),0);
INSERT INTO CLIENT (NAME,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY) VALUES ('AIS MIMO','C',NOW(),0);
INSERT INTO CLIENT (NAME,AUDITFLAG,CREATEDTIMESTAMP,CREATEDBY) VALUES ('KKBANK','C',NOW(),0);
...
--APPLICANT
INSERT INTO APPLICANT (MASCORESKILL_ID,APPLICANT_CODE,FIRSTNAME_TH,FIRSTNAME_EN,LASTNAME_TH,LASTNAME_EN,NICKNAME_TH,NICKNAME_EN,BIRTHDATE,AGE,HEIGHT,WEIGHT,SEX,
RELIGION,NATIONALITY,TEL,EMAIL,APPLICANT_STATUS,APPLY_DATE,EMERGENCY_NAME,EMERGENCY_TEL,EMERGENCY_ADDRESS,NOTICE_NEWSPAPER,NOTICE_MAGAZINE,NOTICE_FRIEND,
NOTICE_WEBSITE,NOTICE_OTHER,NEWSPAPER_DESCRIPTION,MAGAZINE_DESCRIPTION,FRIEND_DESCRIPTION,WEBSITE_DESCRIPTION,OTHER_DESCRIPTION,MASJOBLEVEL_ID,MASTECHNOLOGY_ID,
TRACKING_STATUS,EXPECTED_SALARY,CARD_ID,CARD_ISSUED_OFFICE,CARD_EXPIRY_DATE,MILITARY_FROM_YEAR,MILITARY_TO_YEAR,MILITARY_PLACE,MILITARY_SERVICE_NO,MILITARY_REASON,
NUMBER_OF_CHILDREN,SPOUSE_NAME,MARRIAGE_CERTIFICATE_NO,ISSUE_OFFICE_MARRIAGE,OCCUPATION_MARRIAGE,PLACE_BIRTH,SCORE,TECH_SCORE,ATTITUDE_HOME,ATTITUDE_OFFICE,
NOW_EMPLOYED,EMPLOYED_NAME,EMPLOYED_POSITION,EMPLOYED_RELATION,BRANCH_SERVICE,PREVIOUS_EMPLOYERS,PREVIOUS_EMPLOYERS_REASON,DATE_TO_BE_DRAFTED,MARRIAGE_ADDRESS,
RESUME,TRANSCRIPT,IMAGE,MILITARY_STATUS,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP,OFFICIAL_ID,AUGREQUEST_ID) VALUES 
(1,'C201501','แย้ม','Yam','หมั่นกิจ','Mankit','แย้ม','Yam',STR_TO_DATE('26/01/1940','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(021) 234-5678','yam@gmail.com','Married',STR_TO_DATE('26/05/2015','%d/%m/%Y'),'ประเทือง หมั่นกิจ','(091) 234-5678','บ้านหนองนมวัว','No','No','No','Yes','No','No','No','No','WEBSITE','No','5','2','Pending Test/Interview','25000','1-1116-12232-34-4','บ้านหนองนมวัว',STR_TO_DATE('27/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'ประเทือง หมั่นกิจ','1234','บ้านหนองนมวัว','ชาวนา','Nakon Sawan','40/50','Pass','C#26','S#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),1,null),
(1,'C201502','กาย','Guy','พับ','Pab','กาย','Guy',STR_TO_DATE('26/01/1943','%d/%m/%Y'),75,165,45,'Male','Buddha','Thai','(022) 234-5678','guy@live.com','Married',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'จิตใจ แกร่งกล้า','(092) 234-3241','แบริ่ง','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1-1111-11222-34-5','แบริ่ง',STR_TO_DATE('28/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'จิตใจ กล้าแกร่ง','1234','แบริ่ง','พนักงานบริษัท','Bangkok','40/50','Pass','C#26','S#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),2,null),
(1,'C201503','นิว','New','โวคอล','Vocal','นิว','New',STR_TO_DATE('26/01/1956','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(023) 234-5678','new@hotmail.com','Married',STR_TO_DATE('29/06/2015','%d/%m/%Y'),'อากู๋ แกรมมี่','(093) 432-5678','อโศก','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','3','Pending Test/Interview','25000','1-1151-12622-34-6','อโศก',STR_TO_DATE('29/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'อากู๋ แกรมมี่','1234','อโศก','นักร้อง','Bangkok','40/50','Not','I#24','C#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),3,null),
(1,'C201504','จิ๋ว','Jiew','โวคอล','Vocal','จิ๋ว','Jiew',STR_TO_DATE('26/01/1955','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(024) 234-5678','jiew@windowslive.com','Married',STR_TO_DATE('28/06/2015','%d/%m/%Y'),'อากู๋ แกรมมี่','(094) 234-8765','อโศก','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','4','Pending Test/Interview','25000','1-1121-12822-34-7','อโศก',STR_TO_DATE('30/05/2017','%d/%m/%Y'),'No','No','No','No','No',2,'อากู๋ แกรมมี่','1234','อโศก','นักร้อง','Bangkok','40/50','Pass','D#26','I#24','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),4,null);


--EMPLOYEE
INSERT INTO EMPLOYEE (EMPLOYEE_CODE,TEL_HOME,TEL_FAX,CONGENITAL_DISEASE,HOSPITAL,RELATIONSHIP_WITH_EMERGENCY_CONTACT,PREVIOUS_EMPLOYER,STAFFTYPE_ID,
MAS_CORE_SKILL_ID,DIVISION_ID,LOCATION_ID,EMPLOYMENT_ID,STATUSEMP,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP,APPLICANT_ID,ISMANAGER) VALUES
('TH2015001','(02) 569-9858','(02) 570-9852','allergy','Sukhumvit Hospital','Mom','Yes',1,2,4,1,1,'Employee','C',0,NOW(),1,1),
('TH2015002','(02) 569-9852','(02) 570-9852','allergy','Sukhumvit Hospital','Mom','Yes',2,3,3,1,1,'Employee','C',0,NOW(),2,2),
('TH2015003','(02) 569-9856','(02) 570-9852','allergy','Sukhumvit Hospital','Mom','Yes',1,2,3,1,1,'Employee','C',0,NOW(),3,3);
  
-- Aug Request
--insert INTO AUG_REQUEST (REQUEST_DATE,STATUS,APPROVE_DATE,NUMBER_APPLICANT,SPECIFIC_SKILL,YEAR_EXPERIENCE ,MASJOBLEVEL_ID ,MASTECHNOLOGY_ID ,REQUEST_ID ,APPROVE_ID , AUDITFLAG, CREATEDBY, CREATEDTIMESTAMP,JOBCASE_CODE,JOBCASE_STATUS)
--VALUES (STR_TO_DATE('26/05/2015','%d/%m/%Y'),'New Request',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'2','HibernateSping','3','1','1','1','1','C',0,NOW(),'ITS001','On-boarding'),
--(STR_TO_DATE('26/05/2015','%d/%m/%Y'),'New Request',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'2','HibernateSping','3','2','1','2','1','C',0,NOW(),'ITS002','Full-fill');
...
--Allowance
--INSERT INTO ALLOWANCE(AMOUNT,EMPLOYEE_ID,MAS_ALLOWANCE_ID,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP)
...
--Appointment
--INSERT INTO APPOINTMENT(ID,DETAIL,END,MAIL_STATUS,COLOR,START,TOPIC,APPLICANT_ID,LOGIN_ID)
--VALUES 
--(1,'นัดทำข้อสอบและสอบสัมภาษณ์',STR_TO_DATE('09/10/2015 12:00:00','%d/%m/%Y %H:%i:%s'),0,'#FF4512',STR_TO_DATE('09/10/2015 09:00:00','%d/%m/%Y %H:%i:%s'),'นัดทำข้อสอบคุณ Yam',1,1),
--(2,'นัดเซ็นสัญญา',STR_TO_DATE('12/10/2015 14:00:00','%d/%m/%Y %H:%i:%s'),0,'#FF4512',STR_TO_DATE('12/10/2015 13:00:00','%d/%m/%Y %H:%i:%s'),'นัดเซ็นสัญญาคุณ Piyawut',2,2),
--(3,'นัดเซ็นสัญญา',STR_TO_DATE('14/11/2015 11:00:00','%d/%m/%Y %H:%i:%s'),1,'#91E650',STR_TO_DATE('14/11/2015 10:00:00','%d/%m/%Y %H:%i:%s'),'นัดเซ็นสัญญาคุณ Anut',3,2),
--(4,'นัดทำข้อสอบและสอบสัมภาษณ์',STR_TO_DATE('17/12/2015 12:00:00','%d/%m/%Y %H:%i:%s'),2,'#EBCD26',STR_TO_DATE('17/12/2015 09:00:00','%d/%m/%Y %H:%i:%s'),'นัดทำข้อสอบคุณ Thanatchapong',4,2),
--(5,'นัดเซ็นสัญญา',STR_TO_DATE('19/12/2015 11:00:00','%d/%m/%Y %H:%i:%s'),1,'#91E650',STR_TO_DATE('19/12/2015 10:00:00','%d/%m/%Y %H:%i:%s'),'นัดเซ็นสัญญาคุณ Bill',3,2),
--(6,'นัดทำข้อสอบและสอบสัมภาษณ์',STR_TO_DATE('18/12/2015 12:00:00','%d/%m/%Y %H:%i:%s'),2,'#EBCD26',STR_TO_DATE('18/12/2015 09:00:00','%d/%m/%Y %H:%i:%s'),'นัดทำข้อสอบคุณ Jub',4,2);
