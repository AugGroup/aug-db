...
--Reservation
INSERT INTO RESERVATION (START_TIME,END_TIME,DATE_RESERVATION,DESCRIPTION,ROOM_ID,RESERVATION_TYPE_ID,DIVISION_ID,RESERVATION_BY) VALUES
(STR_TO_DATE('14/11/2015 11:00:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('14/11/2015 15:00:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('14/11/2015','%d/%m/%Y'),'Interview',1,1,1,"Bill Natechanok"),
(STR_TO_DATE('22/10/2015 10:30:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('22/10/2015 17:30:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('22/10/2015','%d/%m/%Y'),'Admin Meeting',2,2,2,"Bank Thanutchapong"),
(STR_TO_DATE('30/10/2015 09:30:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('30/10/2015 18:00:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('30/10/2015','%d/%m/%Y'),'Board Meeting',3,2,3,"Ae Piyawut"),
(STR_TO_DATE('05/11/2015 15:00:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('05/11/2015 18:00:00','%d/%m/%Y %H:%i:%s'),STR_TO_DATE('05/11/2015','%d/%m/%Y'),'Interview',1,2,2,"Jub Pranrajit");
