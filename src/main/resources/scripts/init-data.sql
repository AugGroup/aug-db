...
-- Aug Request
insert INTO AUG_REQUEST (REQUEST_DATE,STATUS,APPROVE_DATE,NUMBER_APPLICANT,SPECIFIC_SKILL,YEAR_EXPERIENCE ,MASJOBLEVEL_ID ,MASTECHNOLOGY_ID ,REQUEST_ID ,APPROVE_ID , AUDITFLAG, CREATEDBY, CREATEDTIMESTAMP,JOBCASE_CODE)
VALUES (STR_TO_DATE('26/05/2015','%d/%m/%Y'),'New Request',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'2','HibernateSping','3','1','1','1','1','C',0,NOW(),'ITS001'),
(STR_TO_DATE('26/05/2015','%d/%m/%Y'),'New Request',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'2','HibernateSping','3','2','1','2','1','C',0,NOW(),'ITS002');
