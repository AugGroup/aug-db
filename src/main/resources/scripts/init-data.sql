...
('C201502','กาย','Guy','พับ','Pab','กาย','Guy',STR_TO_DATE('26/01/1943','%d/%m/%Y'),75,165,45,'Male','Buddha','Thai','(022) 234-5678','guy@live.com','Married',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'จิตใจ แกร่งกล้า','(092) 234-3241','แบริ่ง','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1111-1222-2334-5','แบริ่ง',STR_TO_DATE('28/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'จิตใจ กล้าแกร่ง','1234','แบริ่ง','พนักงานบริษัท','Bangkok','40/50','Pass','C#26','S#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),2),
('C201503','นิว','New','โวคอล','Vocal','นิว','New',STR_TO_DATE('26/01/1956','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(023) 234-5678','new@hotmail.com','Married',STR_TO_DATE('29/06/2015','%d/%m/%Y'),'อากู๋ แกรมมี่','(093) 432-5678','อโศก','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1111-1222-2334-6','อโศก',STR_TO_DATE('29/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'อากู๋ แกรมมี่','1234','อโศก','นักร้อง','Bangkok','40/50','Not','I#24','C#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),3),
('C201504','จิ๋ว','Jiew','โวคอล','Vocal','จิ๋ว','Jiew',STR_TO_DATE('26/01/1955','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(024) 234-5678','jiew@windowslive.com','Married',STR_TO_DATE('28/06/2015','%d/%m/%Y'),'อากู๋ แกรมมี่','(094) 234-8765','อโศก','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1111-1222-2334-7','อโศก',STR_TO_DATE('30/05/2017','%d/%m/%Y'),'No','No','No','No','No',2,'อากู๋ แกรมมี่','1234','อโศก','นักร้อง','Bangkok','40/50','Pass','D#26','I#24','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW(),4);
