...
VALUES ('C201501','แย้ม','Yam','หมั่นกิจ','Mankit','แย้ม','Yam',STR_TO_DATE('26/01/1940','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(021) 234-5678','yam@gmail.com','Married',STR_TO_DATE('26/05/2015','%d/%m/%Y'),'ประเทือง หมั่นกิจ','(091) 234-5678','บ้านหนองนมวัว','No','No','No','Yes','No','No','No','No','WEBSITE','No','4','2','Pending Test/Interview','25000','1111-1222-2334-4','บ้านหนองนมวัว',STR_TO_DATE('27/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'ประเทือง หมั่นกิจ','1234','บ้านหนองนมวัว','ชาวนา','Nakon Sawan','40/50','Pass','C#26','S#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW()),
('C201502','แย้ม','Yam','หมั่นกิจ','Mankit','แย้ม','Yam',STR_TO_DATE('26/01/1940','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(022) 234-5678','yam@gmail.com','Married',STR_TO_DATE('27/05/2015','%d/%m/%Y'),'ประเทือง หมั่นกิจ','(092) 234-5678','บ้านหนองนมวัว','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1111-1222-2334-5','บ้านหนองนมวัว',STR_TO_DATE('27/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'ประเทือง หมั่นกิจ','1234','บ้านหนองนมวัว','ชาวนา','Nakon Sawan','40/50','Pass','C#26','S#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW()),
('C201503','แย้ม','Yam','หมั่นกิจ','Mankit','แย้ม','Yam',STR_TO_DATE('26/01/1940','%d/%m/%Y'),75,165,45,'Male','Buddha','Thai','(023) 234-5678','yam@gmail.com','Married',STR_TO_DATE('29/06/2015','%d/%m/%Y'),'ประเทือง หมั่นกิจ','(093) 234-5678','บ้านหนองนมวัว','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1111-1222-2334-6','บ้านหนองนมวัว',STR_TO_DATE('27/05/2017','%d/%m/%Y'),'No','No','No','No','No',3,'ประเทือง หมั่นกิจ','1234','บ้านหนองนมวัว','ชาวนา','Nakon Sawan','40/50','Not','I#24','C#22','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW()),
('C201504','แย้ม','Yam','หมั่นกิจ','Mankit','แย้ม','Yam',STR_TO_DATE('26/01/1940','%d/%m/%Y'),75,165,45,'Female','Buddha','Thai','(024) 234-5678','yam@gmail.com','Married',STR_TO_DATE('28/06/2015','%d/%m/%Y'),'ประเทือง หมั่นกิจ','(094) 234-5678','บ้านหนองนมวัว','No','No','No','Yes','No','No','No','No','WEBSITE','No','1','2','Pending Test/Interview','25000','1111-1222-2334-7','บ้านหนองนมวัว',STR_TO_DATE('27/05/2017','%d/%m/%Y'),'No','No','No','No','No',2,'ประเทือง หมั่นกิจ','1234','บ้านหนองนมวัว','ชาวนา','Nakon Sawan','40/50','Pass','D#26','I#24','Yes','Ashley','Consultant','friend','No','No','Recently graduated',STR_TO_DATE('27/05/2030','%d/%m/%Y'),'72/2 Moo 5 Behind Somchai Estate,Soi 3,Bangkruay Sai Noi Road, Bangkruay Sub District, Bangkruay District, Nonthaburi Province 11130','resume.pdf','transcript.pdf','image.png','No','C',0,NOW());
...
INSERT INTO EMPLOYEE (EMPLOYEE_CODE,NAME_THAI,SURNAME_THAI,NICKNAME_THAI,NAME_ENG,SURNAME_ENG,NICKNAME_ENG,EMAIL,TEL_HOME,TEL_MOBILE,TEL_FAX,CONGENITAL_DISEASE,HOSPITAL,EMERGENCY_CONTACT,RELATIONSHIP_WITH_EMERGENCY_CONTACT,
		    EMERGENCY_CONTACT_ADDRESS,EMERGENCY_CONTACT_PHONE_NUMBER,DATEOFBIRTH,PLACEOFBIRTH,AGE,RELIGION,ID_CARD,ISSUED_OFFICE,EXPIRY_DATE,HEIGHT,WEIGTH,SEX,MARITAL_STATUS,NUMBER_OF_CHILDREN,SPOUSE_NAME,
		    MARRIAGE_CERTIFICATE_NO,ISSUED_OFFICE2,ADDRESS,OCCUPATION,KNOW_AUG_WEBSITE,DESCRIPTION_WEBSITE,KNOW_EMPLOYED,MILITARY_SERVICE,REASONS_NO,DATE_TO_BE_DRAFTED,PREVIOUS_EMPLOYER,
		    OFFICIAL_ID,STAFFTYPE_ID,MAS_CORE_SKILL_ID,DIVISION_ID,JOBLEVEL_ID,TECHNOLOGY_ID,LOCATION_ID,EMPLOYMENT_ID,STATUSEMP,AUDITFLAG,CREATEDBY,CREATEDTIMESTAMP,APPLICANT_ID,ISMANAGER) VALUES
('TH2015001','เนตรชนก','กลิ่นจันทร์','บิว','Natechanok','Klinjun','Bill','bill@gmail.com',0256998525,08755632988,0257098529,'allergy','Sukhumvit Hospital','Tan','Mom','78/2 Bangkok','0875563298','1991-01-01','Hospital',35,
 'Buddhism',1234567898233,'Dusit','1991-01-01',175,56,'Female','Single',0,'No','No','No','No','No','JobDB','Applicant Java','No','No','Reason No','1991-01-01','Yes',1,2,3,1,1,1,2,1,'Employee','C',0,NOW(),1,1),
 ('TH2015002','เนตรชนกก','กลิ่นจันทร์ก','บิวดด','Natechanok02','Klinjunjo','Bill02','bill2@gmail.com',0256998528,08755632987,0257098529,'allergy','Sukhumvit Hospital','Tan','Mom','78/2 Bangkok','0875563298','1991-01-01','Hospital',35,
 'Buddhism',1234567898233,'Dusit','1991-01-01',175,56,'Female','Single',0,'No','No','No','No','No','JobDB','Applicant Java','No','No','Reason No','1991-01-01','Yes',2,2,3,1,1,1,2,1,'Employee','C',0,NOW(),2,2),
 ('TH2015003','เนตรชนกนนน','กลิ่นจันทร์กกก','บิวกก','Natechanok03','Klinjunjj','Bill03','bill3@gmail.com',0256998522,08755632984,0257098526,'allergy','Sukhumvit Hospital','Tan','Mom','78/2 Bangkok','0875563298','1991-01-01','Hospital',35,
 'Buddhism',1234567898233,'Dusit','1991-01-01',175,56,'Female','Single',0,'No','No','No','No','No','JobDB','Applicant Java','No','No','Reason No','1991-01-01','Yes',3,2,3,1,1,1,2,1,'Employee','C',0,NOW(),3,3);
